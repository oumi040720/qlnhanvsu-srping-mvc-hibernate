...
<section class="site-section">
	<div class="container-fluid">
				...
				<div class="col-md-9 text-center">
					<div class="form-group">
						<div class="row">
							...
							<div class="col-md-6">
								<form action="<c:url value="/record/report/depart/search" />" style="width: 100%;" method="post">
		...
		<div class="col-md-12 text-center">
			<div class="row mb-5 justify-content-center">
				<div class="col-md-9 text-center">
					<form id="form-submit" action='<c:url value="/record/report/depart/search" />' method="get">
						<div class="row">
							<div class="col-md-12">
								<div>
