...
<div class="main-content">
	<div class="container-fluid">
		<h3 class="page-title">
			<s:message code="record.report.depart.title" /> ${year}
		</h3>
		<div class="row">
			<div class="form-group">
				<div class="col-md-6"></div>
				<div class="col-md-6">
					<form action="<c:url value="/admin/record/report/depart/search" />" method="post">
						<div class="col-md-8">
		...
		<br>
		<form id="form-submit" action='<c:url value="/admin/record/report/depart/search" />' method="get">
			<div class="row">
				<div class="col-md-12">
					<div>
