...
<div class="main-content">
	<div class="container-fluid">
		<h3 class="page-title">
			<s:message code="record.report.staff.title" />
		</h3>
		<div class="row">
			<div class="form-group">
				<div class="col-md-6"></div>
				<div class="col-md-6">
					<form action="<c:url value="/admin/record/report/staff/search" />"
						method="post">
						<div class="col-md-8">
		...
		<br>
		<form id="form-submit" action='<c:url value="/admin/record/report/staff" />' method="get">
			<div class="row">
				<div class="col-md-12">
					<div>
								...
								<c:forEach items="${list}" var="row">
									<tr>
										...
										<td><img class="img-thumbnail"
											src="<c:url value="/template/admin/img/staff/${row[4]}" />"
											width="80px" /></td>
										<td>${row[0]}- ${row[1]}</td>
										<td>${row[2]}</td>
										<td>${row[3]}</td>
